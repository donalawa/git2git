let Conf,configKey,getRemote,pushOnline,throws;_9c1‍.x([["pushAll",()=>pushAll]]);_9c1‍.w("conf",[["default",["Conf"],function(v){Conf=v}]]);_9c1‍.w("./config",[["configKey",["configKey"],function(v){configKey=v}]]);_9c1‍.w("./utils",[["getRemote",["getRemote"],function(v){getRemote=v}],["pushOnline",["pushOnline"],function(v){pushOnline=v}]]);_9c1‍.w("assert",[["throws",["throws"],function(v){throws=v}]]);/**
...
const{ execSync } = require('child_process');
  ...
  _9c1‍.g.console.log(chalk.blueBright(`Done All Pushed Successfully`))
}
